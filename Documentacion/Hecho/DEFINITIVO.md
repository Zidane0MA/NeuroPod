...
### 1. Implementación del Modal de Conexión
...
### 2. Implementación de las tablas de Pods
...
### 4. Implementación de las páginas de Pods
...
### 1. Servicio de Monitoreo de Pods en el Backend
...
1. HTTPS: Todo el tráfico debe estar protegido por HTTPS (Cloudflare lo proporciona), Aunque Cloudflare maneja HTTPS externamente, es recomendable tener TLS dentro del clúster
